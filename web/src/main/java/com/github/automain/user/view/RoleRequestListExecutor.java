...
public class RoleRequestListExecutor extends BaseExecutor {
    ...
    protected String doAction(ConnectionBean connection, Jedis jedis, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        PageBean<TbRoleRequestMapping> pageBean = TB_ROLE_REQUEST_MAPPING_SERVICE.selectTableForRole(connection, DispatcherController.getRequestUrlList(), request, roleId);

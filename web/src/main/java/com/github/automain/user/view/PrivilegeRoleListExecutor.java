...
@RequestUrl("/privilege/role/list")
public class PrivilegeRoleListExecutor extends BaseExecutor {
    ...
    protected String doAction(ConnectionBean connection, Jedis jedis, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        PageBean<TbRole> pageBean = TB_ROLE_SERVICE.selectTableForForPrivilege(connection, bean, request, privilegeId);
        request.setAttribute(PAGE_BEAN_PARAM, pageBean);
        return "user/privilege_role_list";
    }
}
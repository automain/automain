...
<form class="layui-form layui-form-pane" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" autocomplete="off" name="ip" lay-verify="ip">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">端口号</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" autocomplete="off" name="port" lay-verify="port">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(inner_ip_port_submit)', function (data) {
            ...
            if (!submitBtn.hasClass("layui-btn-disabled")) {
                ...
                $.post("${ctx}/inner/ip/port/add", data.field, function (data) {
                    layer.msg(data.msg);

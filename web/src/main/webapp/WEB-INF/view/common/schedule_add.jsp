...
<form class="layui-form layui-form-pane" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" autocomplete="off" name="scheduleName" lay-verify="schedule_name">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">任务请求url</label>
        <div class="layui-input-block">
            <textarea class="layui-textarea" name="scheduleUrl" lay-verify="schedule_url"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" class="layui-input" autocomplete="off" name="delayTime" lay-verify="delay_time">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(schedule_submit)', function (data) {
            ...
            if (!submitBtn.hasClass("layui-btn-disabled")) {
                ...
                $.post("${ctx}/schedule/add", data.field, function (data) {
                    layer.msg(data.msg);

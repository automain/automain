...
<form class="layui-form layui-form-pane" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" autocomplete="off" name="privilegeLabel" lay-verify="privilege_label">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">权限名称</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" autocomplete="off" name="privilegeName" lay-verify="privilege_name">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(privilege_submit)', function (data) {
            ...
            if (!submitBtn.hasClass("layui-btn-disabled")) {
                ...
                $.post("${ctx}/privilege/add", data.field, function (data) {
                    layer.msg(data.msg);

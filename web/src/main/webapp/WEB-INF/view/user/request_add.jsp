...
<form class="layui-form layui-form-pane" action="">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea class="layui-textarea" name="operationClass" lay-verify="operation_class"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">注释</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" autocomplete="off" name="urlComment" lay-verify="url_comment">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(request_submit)', function (data) {
            ...
            if (!submitBtn.hasClass("layui-btn-disabled")) {
                ...
                $.post("${ctx}/request/add", data.field, function (data) {
                    layer.msg(data.msg);

...
<form class="layui-form layui-form-pane" action="">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" autocomplete="off" name="testName" lay-verify="test_name">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">测试textarea</label>
        <div class="layui-input-block">
            <textarea class="layui-textarea" name="testArea" lay-verify="test_area"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">创建时间</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" id="createTime" name="createTime" lay-verify="create_time">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">测试数量</label>
        <div class="layui-input-block">
            <input type="number" class="layui-input" autocomplete="off" name="testAmount" lay-verify="test_amount">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="testType">
                <c:forEach items="${testTypeVOList}" var="item">
                    <option value="${item.dictionaryValue}">${item.dictionaryName}</option>
                </c:forEach>
            </select>
        </div>
    </div>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(test_submit)', function (data) {
            ...
            if (!submitBtn.hasClass("layui-btn-disabled")) {
                ...
                $.post("${ctx}/test/add", data.field, function (data) {
                    layer.msg(data.msg);
